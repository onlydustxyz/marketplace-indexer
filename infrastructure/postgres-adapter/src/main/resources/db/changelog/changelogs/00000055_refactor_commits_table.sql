...
insert into indexer_exp.github_commits(sha, author_id, tech_created_at, tech_updated_at)
select c.sha, c.author_id, c.tech_created_at, c.tech_updated_at
from indexer_raw.commits c;

create table indexer_exp.github_pull_requests_commits
(
    commit_sha      text                     not null references indexer_exp.github_commits (sha),
...
insert into indexer_exp.github_pull_requests_commits(commit_sha, pull_request_id, tech_created_at, tech_updated_at)
select prc.commit_sha, prc.pull_request_id, prc.tech_created_at, prc.tech_updated_at
from indexer_raw.pull_request_commits prc
         join indexer_exp.github_pull_requests gpr on gpr.id = prc.pull_request_id;
