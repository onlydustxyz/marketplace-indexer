...
public class RepoJobIndexingIT extends IntegrationTest {
    ...
    public void should_add_repo_to_index() throws IOException {
        // Given
        final Integer MARKETPLACE = 498695724;
        ...
        assertThat(repoIndexingJobTriggerRepository.list()).containsExactly(new RepoIndexingJobTrigger(0L, MARKETPLACE.longValue()));
    }

    private WebTestClient.ResponseSpec indexRepo(Integer repoId) {
